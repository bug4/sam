...
const TokenInfo = ({ onButtonClick }) => {
  ...
  const TOKEN_ADDRESS = isLaunched ? "6FgVCiniDGR9MEADvPnjt1umJBQjrSbWsAEQAcyApump" : null;
...
<div className="fixed top-10 left-10 z-40">
  ...
  <a
      href="https://x.com/AeonProtocolAI"
      onClick={playClick}
      target="_blank"
...
<div className="fixed top-4 right-4 z-40">
  <a
    href="https://pump.fun/coin/6FgVCiniDGR9MEADvPnjt1umJBQjrSbWsAEQAcyApump"
    target="_blank"
    rel="noopener noreferrer"
