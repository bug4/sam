...
const DocsTerminal = ({ onButtonClick, isOpen, setIsOpen }) => {
  ...
  const docs = {
    overview: `BSA Protocol is a decentralized financial ecosystem built on Solana Smart Chain. 
    ...
    architecture: [
      {
        ...
        content: [
          "Total Supply: 1,000,000,000 BSA",
    ...
    features: [
      "BSA Terminal - Direct access to SOL ecosystem",
  ...
  const renderContent = () => {
    switch (selectedSection) {
      case 'overview':
        return (
          <div className="space-y-4">
            <h3 className="text-green-500 text-lg">BSA Overview</h3>
      ...
      case 'architecture':
        return (
          <div className="space-y-6">
            <h3 className="text-green-500 text-lg">BSA Architecture</h3>
      ...
      case 'features':
        return (
          <div className="space-y-4">
            <h3 className="text-green-500 text-lg">BSA Features</h3>
      ...
      <div className="relative w-full max-w-4xl bg-black border border-green-500 shadow-lg shadow-green-500/20 m-4">
        <div className="flex items-center justify-between p-2 border-b border-green-500/50 bg-green-500/10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-green-500 font-mono text-sm">BSA SOL Documentation</span>
          </div>
          <button 
            onClick={() => {
              onButtonClick();
