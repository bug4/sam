          ...
          <div className="p-6">
            {isSubmitted ? (
              <div className="text-center space-y-4 py-8">
                ...
                <p className="text-yellow-500 font-mono">Agent submission processed. Awaiting SAM's approval...</p>
              </div>
            ) : (
                ...
                <div className="p-4 border border-yellow-500/30 bg-yellow-500/5">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-yellow-500/80 text-sm font-mono">
                      All submitted agents undergo rigorous evaluation by SAM's core systems. 
                      Approved agents will be deployed to enhance the SAM ecosystem on Pump.fun.
                    </p>
                  </div>
                </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-400/80 font-mono text-sm">
                Your agent has been queued for review. If approved, it will be deployed to enhance the SAM ecosystem on Pump.fun.
              </p>
            </div>
          </div>
